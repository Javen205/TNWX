...
export class WxMiniGameApi {
   ...
   * @param isHyaline
   */
  public static async getWxAcode(path: string, width: number = 430, autoColor: boolean = false, lineColor: string = '{"r":0,"g":0,"b":0}', isHyaline: boolean = false) {
    let accessToken = await AccessTokenApi.getAccessToken()
